...
public class ScoreFunction implements ToIntFunction<GameSelection> {
  ...
  private static final Map<GameSelection, Integer> scoreTable =
      Map.of(
          ...
          LOSE_SCORE + ROCK_SCORE,
          new GameSelection(Selection.PAPER, Selection.SCISSORS),
          LOSE_SCORE + PAPER_SCORE,
          new GameSelection(Selection.SCISSORS, Selection.ROCK),
          LOSE_SCORE + SCISSORS_SCORE,
          new GameSelection(Selection.ROCK, Selection.ROCK),
          DRAW_SCORE + ROCK_SCORE,
          new GameSelection(Selection.PAPER, Selection.PAPER),
          DRAW_SCORE + PAPER_SCORE,
          new GameSelection(Selection.SCISSORS, Selection.SCISSORS),
          DRAW_SCORE + SCISSORS_SCORE,
          new GameSelection(Selection.ROCK, Selection.SCISSORS),
          WIN_SCORE + ROCK_SCORE,
          new GameSelection(Selection.PAPER, Selection.ROCK),
          WIN_SCORE + PAPER_SCORE,
          new GameSelection(Selection.SCISSORS, Selection.PAPER),
