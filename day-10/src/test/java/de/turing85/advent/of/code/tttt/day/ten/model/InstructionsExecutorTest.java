...
class InstructionsExecutorTest {
  ...
  class SignalStrengthTest {
    ...
    void correctResultOnCommonInput() throws IOException {
      ...
      // WHEN
      int actual =
          InstructionsExecutor.executeFilterMapReduce(
              new FromFileInstructionsWithParameterSupplier(COMMON_INPUT).get(),
              CYCLE_FILTER,
              CYCLES_TIMES_X_REGISTER,
              0,
              Integer::sum);
    ...
    void correctResultOnPersonalInput() throws IOException {
      ...
      int actual =
          InstructionsExecutor.executeFilterMapReduce(
              new FromFileInstructionsWithParameterSupplier(PERSONAL_INPUT).get(),
              CYCLE_FILTER,
              CYCLES_TIMES_X_REGISTER,
              0,
              Integer::sum);
