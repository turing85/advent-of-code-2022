...
/**
 * Returns the (always positive) <a href="https://en.wikipedia.org/wiki/Ring_(mathematics)">Ring</a>
 * value of {@link #value()}.
 *
 * <p>
 * The ring value is calculated by
 *
 * <pre>
 ...
 */
public int ringValue(int ringSize){int mod=ringSize-1;return(((int)(value()%mod))+mod)%mod;}}
