...
import static de.turing85.advent.of.code.tttt.day.four.model.IntervalContainCheckerTest.COMMON_INPUT_URI;
import static de.turing85.advent.of.code.tttt.day.four.model.IntervalContainCheckerTest.PERSONAL_INPUT_URI;
...
class IntervalOverlapCheckerTest {
  ...
  void correctOnCommonInput() throws Exception {
    ...
    // WHEN
    int actual =
        UNDER_TEST.countIntervalOverlaps(new FromFileIntervalPairSupplier(COMMON_INPUT_URI).get());
  ...
  void correctOnPersonalInput() throws Exception {
    ...
    int actual = UNDER_TEST
        .countIntervalOverlaps(new FromFileIntervalPairSupplier(PERSONAL_INPUT_URI).get());
