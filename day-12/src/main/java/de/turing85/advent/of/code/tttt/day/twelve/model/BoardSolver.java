...
public class BoardSolver {
  ...
  /**
   * Finds the length of the shortest path from any point that satisfies the {@code
   * startFieldCondition} to the {@code endField}.
   *
  ...
  public static int findShortestPathLength(
      Board board, Predicate<Field> startFieldCondition, Field endField) {
    ...
    while (true) {
      ...
      List<Field> fields =
          board.reachableFromNeighbours(currentFieldWithDistance.field()).stream()
